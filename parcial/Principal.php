...
$allPerson="SELECT * FROM `usuarios` AS us JOIN roles as rol on us.id_rol=rol.id_roles";
$exectPerson=mysqli_query($conexion,$allPerson);
        ...
        <div class="row centrado">
            <form style="padding: 5%;" action="" method="post">
                <div class="usuario">
                    ...
                    <a style="margin-left: 50%;" class="btn btn-info" href="cerrar.php" >Personas</a>
                </div>
                <div class="contenedorTabla">
                    <div id="encabezado">
                        <b>Tabla de usuarios</b>
                        <a style="margin-left: 75%;" class="btn btn-primary " href="agregar.php">Agregar</a>
                    </div>
                    <div class="tabla">
